...
def kontrolli_makset():
    ...
    if response.status_code == 200:
        ...
        if seisund == "settled":
            saada_email("kotikj89@gmail.com", payment_reference)
    else:
...
original_pilt = Image.open(r"C:\Users\kotik\source\repos\Ulesanned\bg111.png")
resize_pilt = original_pilt.resize((700, 300))
bgpilt = ImageTk.PhotoImage(resize_pilt)

# Устанавливаем фон
labelBg = Label(app, image=bgpilt)
