...
def insert_data():
    if validate_data():
        ...
        dbdir=filename.rstrip('MovieDB.py')
...
def on_update():
    ...
    if selected_item:
        ...
        vastus_update.configure(text=f"Valitud ID: {record_id}") 
...
# Lisame label kuhu kirjutame vastu update_button
vastus_update = tk.Label(root, text="...")
vastus_update.pack(padx=10)
